...
start_day=datetime.datetime(2017,5,12).date()
...
while True:
    ...
    if day > yesterday:
        break
    if db1.find_one({'ts_string':day,'source':'edu'}):
        i+=1
        continue
    #all category
    col=client.xdf.courses.find({'ts_str':day},{'course_id':1,'city':1})
    s={}
